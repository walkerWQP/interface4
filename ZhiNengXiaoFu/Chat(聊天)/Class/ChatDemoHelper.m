...
- (void)setMainVC:(TotalTabBarController *)mainVC
{
    _mainVC = mainVC;
...
{
    [self _clearHelper];
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"您的帐户已从服务器端删除" delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    [alertView show];
                                       ...
                                       ext:(NSString *)aExt
{
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"好友多设备通知" message:message delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    [alertView show];
                                     ...
                                     ext:(id)aExt
{
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"群组多设备通知" message:message delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    [alertView show];
                       ...
                       muteExpire:(NSInteger)aMuteExpire
{
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"聊天室更新" message:@"禁言" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
    [alertView show];
}
