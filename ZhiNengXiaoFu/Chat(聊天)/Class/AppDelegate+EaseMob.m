...
- (void)loginStateChange:(NSNotification *)notification
{
    ...
    MainNavigationController *navigationController = nil;
    if (loginSuccess) {//登陆成功加载主窗口控制器
        //加载申请通知的数据
        [[ApplyViewController shareController] loadDataSourceFromLocalDB];
        if (self.mainController == nil) {
            self.mainController = [[TotalTabBarController alloc] init];
            navigationController = [[MainNavigationController alloc] initWithRootViewController:self.mainController];
        }else{
            navigationController  = (MainNavigationController *)self.mainController.navigationController;
        }
        ...
        LoginHomePageViewController *loginController = [[LoginHomePageViewController alloc] init];
